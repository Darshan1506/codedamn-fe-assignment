...
const Work: React.FC<ProjectCardProps> = ({
  img,
  name,
  location,
  date,
  ...
  return (
    <div className="p-4 mb-4 max-w-4xl	 bg-white border hover:bg-gray-100 dark:hover:bg-gray-700 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
